                ...
                >
                    <article className="overflow-hidden rounded-lg shadow-lg">
                        <div className="relative flex justify-center items-center">
                            ...
                            <div className={"absolute " + ( hoverCard === item.id ? `opacity-100` : `opacity-0`)}>
                        ...
                        <footer className="flex items-center justify-between leading-none p-2 md:p-4">
                            <a className="flex items-center no-underline hover:underline text-black" href="#">
                                <img className="inline-block h-20 w-20 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />

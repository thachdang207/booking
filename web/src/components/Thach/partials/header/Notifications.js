...
function Notifications() {
  ...
  return (
    <div className="relative inline-flex ml-3">
      ...
      <Transition
        className="origin-top-right z-10 absolute top-full right-0 -mr-48 sm:mr-0 w-96 bg-white border border-gray-200 py-1.5 rounded shadow-lg overflow-hidden mt-1"
        show={dropdownOpen}

    ...
    return (
        <div
            className={
                hidden
                    ? "hidden"
                    : "w-full md:w-1/2 text-center bg-red-100 border border-red-400 text-red-700 px-12 py-3 rounded-sm fixed top-0 left-1/2 transform -translate-x-1/2 translate-y-0 z-50 mt-5"
            }
            role="alert"
        >
